...
# Install Stable version of Fluentd.
...
td-agent-gem install --no-document fluent-plugin-kubernetes_metadata_filter -v 0.28.0
td-agent-gem install --no-document fluent-plugin-elasticsearch -v 1.9.5
td-agent-gem install --no-document fluent-plugin-concat -v 1.0.0
td-agent-gem install --no-document fluent-plugin-flatten-hash -v 0.4.1
